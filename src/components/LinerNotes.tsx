  ...
  return (
    <section id="liner-notes" className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto max-w-4xl">
        ...
        <div className="relative p-10 md:p-14 rounded-3xl bg-gradient-to-br from-muted/50 to-muted/20 border border-primary/20 backdrop-blur-sm animate-fade-in space-y-7 font-cormorant text-lg md:text-xl text-foreground/90 leading-relaxed mb-12">
          <div className="absolute top-0 right-0 w-40 h-40 bg-primary/5 rounded-full blur-3xl" />
          
          <div className="relative space-y-7">
            <h3 className="font-cinzel text-2xl font-bold text-foreground border-b border-primary/20 pb-4">
              My Bohemian Baptism
            </h3>
            <p>
            ...
            <div className="space-y-5 pl-0 md:pl-4 border-l-2 border-primary/30">
              {[
                ...
                <div key={entry.title} className="pl-4 md:pl-6">
                  <span className="font-cinzel font-bold text-primary text-base">{entry.title}</span>
        ...
        <div className="relative p-10 md:p-14 rounded-3xl bg-gradient-to-br from-muted/50 to-muted/20 border border-accent/20 backdrop-blur-sm animate-fade-in space-y-7 font-cormorant text-lg md:text-xl text-foreground/90 leading-relaxed">
          ...
          <div className="relative space-y-7">
            <h3 className="font-cinzel text-2xl font-bold text-foreground border-b border-accent/20 pb-4">
